...
const TODAY_AUTO_SCROLL_MS = 4500;
const TODAY_RESUME_DELAY_MS = 1800;
...
export default function HomeScreen() {
  ...
  const todayCycleHeight = useMemo(
    () => (todayRowHeight ? todayRowHeight * TODAY_ITEMS.length : 0),
    [todayRowHeight]
  );
      ...
      <ScrollView style={styles.page} contentContainerStyle={styles.pageContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.shortcutsBlock}>
          ...
          <View style={styles.shortcutsGrid}>
            {SHORTCUTS.map((s) => (
              <TouchableOpacity key={s.id} style={styles.shortcutTile} activeOpacity={0.88} onPress={() => onShortcutPress(s)}>
