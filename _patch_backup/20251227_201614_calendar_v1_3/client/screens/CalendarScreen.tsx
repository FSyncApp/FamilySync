...
/**
 * Calendar v1.2.1 (Phase 1 thin slice)
 * - Calendar v1.2 + Week navigation controls
 *   - Month arrows: move by month (as before)
 *   - NEW: Week arrows: move by week (±7 days) so you can browse other weeks
 * - Keeps TimeTree-style "Day Sheet" agenda structure (empty placeholders)
 * - No data wiring
